      ...
      >
        ...
        <form onSubmit={submit} className="mt-6 space-y-4">
          ...
          <ConsentCheckbox checked={marketing} onChange={setMarketing}>
            I&rsquo;m happy for MEDfacials to contact me about my result and
            relevant offers. Optional — you&rsquo;ll see your result either way.
          </ConsentCheckbox>

          {error && (
            <p className="rounded-xl bg-peach-light/40 px-4 py-2.5 text-sm text-heading">
              {error}
            </p>
          )}
