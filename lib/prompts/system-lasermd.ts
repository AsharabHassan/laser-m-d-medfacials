...
- concernClarity (0–40): how CLEARLY LaseMD-treatable skin concerns are visible — pigmentation, sun damage, redness, texture, pores, fine lines, dullness. Clear, visible concerns score HIGH (this is exactly who LaseMD helps); near-flawless skin scores mid (glow and maintenance still benefit), never near zero.
- skinReadiness (0–30): apparent skin health and resilience for a gentle fractional laser. Be lenient — LaseMD tolerates most skin well; score high unless the skin looks acutely irritated or compromised.
- rejuvenationPotential (0–30): how much visible improvement is realistically achievable for this face — brighter, clearer, smoother, more even.
These three sum to the suitability score, so weigh each honestly for THIS face — a clear candidate should total in the high 70s to low 90s; totals below 60 should be rare and reserved for unreadable photos. Different faces should produce different totals.
